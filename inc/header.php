...
<header>
    ...
    <div id="top-header">
        <div class="container">
            <ul class="header-links pull-left">
                <li><a href="#"><i class="fa fa-phone"></i> 0904921183</a></li>
                <li><a href="#"><i class="fa fa-envelope-o"></i> Docaodang532001@gmail.com</a></li>
                <li><a href="#"><i class="fa fa-map-marker"></i> Vĩnh Phúc</a></li>
            </ul>
    ...
    <div id="header">
        ...
        <div id="alert-boxAdd" class="alert-box success">Thêm vào giỏ hàng thành công !!!</div>
